...
$card_name="";
if(isset($_POST['card_name']))$card_name=$_POST['card_name'];

$card_edc="";
if(isset($_POST['card_edc']))$card_edc=$_POST['card_edc'];
...
$sf.=",deposit_amount='$amount',payment_amount='0',trans_type='Tran In'";
...
how_paid='CreditCard',amount_paid='$amount',credit_card_number='$card_no',expiration_date='',
credit_card_type='$card_edc',authorization='$card_name' ";
mysqli_query($db->con,$s); 
