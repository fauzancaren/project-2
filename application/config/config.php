...
$config['base_url'] = "http://$servername:$port/software.jobii.id/";
/*
|--------------------------------------------------------------------------
| Index File
|--------------------------------------------------------------------------
...
//0-multicompany diferent database, 1-multicompany one single database
$config['multi_company_type']=0;    
$config['check_outlet_active']=false;    //periksa apakah perlu pilih gudang dulu?
$config['chatbox_visible']=false;
$config['show_only_current_sid']=false;
