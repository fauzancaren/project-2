...
class Lookup extends CI_Controller {
    ...
    function sys_sql($key){
        $sql="";
        $s="select * from sys_sql where sql_id='$key'";
    ...
    function sys_sql_data($key){
        $sql=$this->sys_sql($key);
		if($sql==""){
			echo "<div class='alert alert-warning'>unknwon key <b>[$key]</b> from table <b>sys_sql</b> addnew !</div>";
		} else {
            echo datasource($sql);		        
		}
    }
