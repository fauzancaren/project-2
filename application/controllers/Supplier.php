...
class Supplier extends CI_Controller {
	...
	function save(){
		...
		if($ok){
			...
			echo json_encode(array("success"=>false,"msg"=>"Error ".show_error('save')));
		}
	...
	function browse($offset=0,$limit=10,$order_column='suppliers',$order_type='asc')
	{
		...
		$data['fields_caption']=array('Kode','Nama Supplier','Termin','Kota','Phone','Fax',
		'Email','Contact','Street','Suite','Cid');
		$data['fields']=array('supplier_number','supplier_name','payment_terms','city','phone','fax',
        'email','first_name','street','suite','cid'
        );
