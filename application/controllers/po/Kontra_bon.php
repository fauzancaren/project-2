...
class Kontra_bon extends CI_Controller {
	...
	function __construct()
	{
		...
		$this->sql = "select nomor,tanggal,i.termin,tgl_jth_tempo,i.supplier_number,s.supplier_name,
		    amount,paid
	...
	function save(){
		...
		$dout=$this->payables_bill_header_model->_data;
		if ($ok){
			echo json_encode(array('success'=>true,'nomor'=>$id,"msg"=>"Success","data"=>$dout));
		} else {
