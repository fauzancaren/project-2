...
class Promosi_voucher extends CI_Controller {
    ...
    function browse_data($offset=0,$limit=100,$nama=''){
        ...
        $d1="";if($this->input->get('sid_date_from')) $d1= date( 'Y-m-d H:i:s', strtotime($this->input->get('sid_date_from')));
        $d2="";if($this->input->get('sid_date_to'))$d2= date( 'Y-m-d H:i:s', strtotime($this->input->get('sid_date_to')));
