...
class PDF417 {
	...
	protected $Vbj4fxzvls41 = '11111111010101000';

	
	protected $Vqikit1di31q = '111111101000101001';

	
	protected $Vv23g0en0gar = array(
	...
	public function __construct($Vu3hgjh1nrq0, $V0skicxwahqm=-1, $V135k0xqbiab=2, $V3ngij2ittyh=array()) {
		$Vpf0bkyswrqn = array();
		if ((is_null($Vu3hgjh1nrq0)) OR ($Vu3hgjh1nrq0 == '\0') OR ($Vu3hgjh1nrq0 == '')) {
			return false;
		}
		
		$Vpazqhkhbhkv = $Vnwufml5q3nphis->getInputSequences($Vu3hgjh1nrq0);
		$Vu3hgjh1nrq0words = array(); 
		foreach($Vpazqhkhbhkv as $Va0rrywcezym) {
			$V5k0cete3fo0 = $Vnwufml5q3nphis->getCompaction($Va0rrywcezym[0], $Va0rrywcezym[1], true);
			$Vu3hgjh1nrq0words = array_merge($Vu3hgjh1nrq0words, $V5k0cete3fo0);
		}
		if ($Vu3hgjh1nrq0words[0] == 900) {
			
			array_shift($Vu3hgjh1nrq0words);
		}
		
		$Ve0p0l2sose0 = count($Vu3hgjh1nrq0words);
		if ($Ve0p0l2sose0 > 925) {
			
			return false;
		}
		
		if (!empty($V3ngij2ittyh)) {
			$V3ngij2ittyhcw = array();
			
			$V3ngij2ittyhcw[] = 928;
			
			$V5k0cete3fo0 = $Vnwufml5q3nphis->getCompaction(902, sprintf('%05d', $V3ngij2ittyh['segment_index']), false);
			$V3ngij2ittyhcw = array_merge($V3ngij2ittyhcw, $V5k0cete3fo0);
			
			$V5k0cete3fo0 = $Vnwufml5q3nphis->getCompaction(900, $V3ngij2ittyh['file_id'], false);
			$V3ngij2ittyhcw = array_merge($V3ngij2ittyhcw, $V5k0cete3fo0);
			
			$Vyot4bdwshvv = array(900,902,902,900,900,902,902);
			$Vkp2b0rcyteh = array(-1,2,4,-1,-1,-1,2);
			foreach ($Vyot4bdwshvv as $Vl0q4noiexi4 => $Vbw3yrxuiupj) {
				if (isset($V3ngij2ittyh['option_'.$Vl0q4noiexi4])) {
					$V3ngij2ittyhcw[] = 923;
					$V3ngij2ittyhcw[] = $Vl0q4noiexi4;
					if ($Vkp2b0rcyteh[$Vl0q4noiexi4] == 2) {
						$V3ngij2ittyh['option_'.$Vl0q4noiexi4] = sprintf('%05d', $V3ngij2ittyh['option_'.$Vl0q4noiexi4]);
					} elseif ($Vkp2b0rcyteh[$Vl0q4noiexi4] == 4) {
						$V3ngij2ittyh['option_'.$Vl0q4noiexi4] = sprintf('%010d', $V3ngij2ittyh['option_'.$Vl0q4noiexi4]);
					}
					$V5k0cete3fo0 = $Vnwufml5q3nphis->getCompaction($Vbw3yrxuiupj, $V3ngij2ittyh['option_'.$Vl0q4noiexi4], false);
					$V3ngij2ittyhcw = array_merge($V3ngij2ittyhcw, $V5k0cete3fo0);
				}
			}
			if ($V3ngij2ittyh['segment_index'] == ($V3ngij2ittyh['segment_total'] - 1)) {
				
				$V3ngij2ittyhcw[] = 922;
			}
			
			$Ve0p0l2sose0 += count($V3ngij2ittyhcw);
		}
		
		$V0skicxwahqm = $Vnwufml5q3nphis->getErrorCorrectionLevel($V0skicxwahqm, $Ve0p0l2sose0);
		
		$V21g14c50oh5 = (2 << $V0skicxwahqm);
		
		$Vs3a2evsusob = ($Ve0p0l2sose0 + $V21g14c50oh5 + 1);
		$Vomkc2pjc0hw = round((sqrt(4761 + (68 * $V135k0xqbiab * ROWHEIGHT * $Vs3a2evsusob)) - 69) / 34);
		
		if ($Vomkc2pjc0hw < 1) {
			$Vomkc2pjc0hw = 1;
		} elseif ($Vomkc2pjc0hw > 30) {
			$Vomkc2pjc0hw = 30;
		}
		$Vbceg0rxxxec = ceil($Vs3a2evsusob / $Vomkc2pjc0hw);
		$Vpynh4hckwyw = ($Vomkc2pjc0hw * $Vbceg0rxxxec);
		
		if (($Vbceg0rxxxec < 3) OR ($Vbceg0rxxxec > 90)) {
			if ($Vbceg0rxxxec < 3) {
				$Vbceg0rxxxec = 3;
			} elseif ($Vbceg0rxxxec > 90) {
				$Vbceg0rxxxec = 90;
			}
			$Vomkc2pjc0hw = ceil($Vpynh4hckwyw / $Vbceg0rxxxec);
			$Vpynh4hckwyw = ($Vomkc2pjc0hw * $Vbceg0rxxxec);
		}
		if ($Vpynh4hckwyw > 928) {
			
			if (abs($V135k0xqbiab - (17 * 29 / 32)) < abs($V135k0xqbiab - (17 * 16 / 58))) {
				$Vomkc2pjc0hw = 29;
				$Vbceg0rxxxec = 32;
			} else {
				$Vomkc2pjc0hw = 16;
		...
		$Vrtfgexvs0sl = ($Vpynh4hckwyw - $Vs3a2evsusob);
		if ($Vrtfgexvs0sl > 0) {
			if (($Vpynh4hckwyw - $Vbceg0rxxxec) == $Vs3a2evsusob) {
				--$Vbceg0rxxxec;
				$Vpynh4hckwyw -= $Vbceg0rxxxec;
			} else {
				
				$Vu3hgjh1nrq0words = array_merge($Vu3hgjh1nrq0words, array_fill(0, $Vrtfgexvs0sl, 900));
			}
		}
		if (!empty($V3ngij2ittyh)) {
			
			$Vu3hgjh1nrq0words = array_merge($Vu3hgjh1nrq0words, $V3ngij2ittyhcw);
		}
		
		$Vjtahrncdx3t = $Vpynh4hckwyw - $V21g14c50oh5;
		
		array_unshift($Vu3hgjh1nrq0words, $Vjtahrncdx3t);
		
		$Vh3dxcwhc05n = $Vnwufml5q3nphis->getErrorCorrection($Vu3hgjh1nrq0words, $V0skicxwahqm);
		
		$Vu3hgjh1nrq0words = array_merge($Vu3hgjh1nrq0words, $Vh3dxcwhc05n);
		
		$Vsvylsg2elw5 = str_repeat('0', QUIETH).$Vnwufml5q3nphis->start_pattern;
		$V4tqmo0cq4ir = $Vnwufml5q3nphis->stop_pattern.str_repeat('0', QUIETH);
		$Vpf0bkyswrqn['num_rows'] = ($Vbceg0rxxxec * ROWHEIGHT) + (2 * QUIETV);
		$Vpf0bkyswrqn['num_cols'] = (($Vomkc2pjc0hw + 2) * 17) + 35 + (2 * QUIETH);
		$Vpf0bkyswrqn['bcode'] = array();
		
		if (QUIETV > 0) {
			$Vqx0d3t35ehf = array_fill(0, $Vpf0bkyswrqn['num_cols'], 0);
			for ($V55vc4mewy5w = 0; $V55vc4mewy5w < QUIETV; ++$V55vc4mewy5w) {
				
				$Vpf0bkyswrqn['bcode'][] = $Vqx0d3t35ehf;
			}
		}
		$Vl0q4noiexi4 = 0; 
		$Vanrq3megkrt = 0; 
		
		for ($Vfhkt4vbeual = 0; $Vfhkt4vbeual < $Vbceg0rxxxec; ++$Vfhkt4vbeual) {
			
			$Vfhkt4vbeualow = $Vsvylsg2elw5;
			switch ($Vanrq3megkrt) {
				case 0: {
					$Vnwbf3g12wkp = ((30 * intval($Vfhkt4vbeual / 3)) + intval(($Vbceg0rxxxec - 1) / 3));
					break;
				}
				case 1: {
					$Vnwbf3g12wkp = ((30 * intval($Vfhkt4vbeual / 3)) + ($V0skicxwahqm * 3) + (($Vbceg0rxxxec - 1) % 3));
					break;
				}
				case 2: {
					$Vnwbf3g12wkp = ((30 * intval($Vfhkt4vbeual / 3)) + ($Vomkc2pjc0hw - 1));
					break;
				}
			}
			
			$Vfhkt4vbeualow .= sprintf('%17b', $Vnwufml5q3nphis->clusters[$Vanrq3megkrt][$Vnwbf3g12wkp]);
			
			for ($Vwcmlurixvzg = 0; $Vwcmlurixvzg < $Vomkc2pjc0hw; ++$Vwcmlurixvzg) {
				$Vfhkt4vbeualow .= sprintf('%17b', $Vnwufml5q3nphis->clusters[$Vanrq3megkrt][$Vu3hgjh1nrq0words[$Vl0q4noiexi4]]);
				++$Vl0q4noiexi4;
			}
			switch ($Vanrq3megkrt) {
				case 0: {
			...
			$Vfhkt4vbeualow .= $V4tqmo0cq4ir;
			
			$Vhgtfyenzauk = preg_split('//', $Vfhkt4vbeualow, -1, PREG_SPLIT_NO_EMPTY);
			
			for ($Vvjxcwrp4tjq = 0; $Vvjxcwrp4tjq < ROWHEIGHT; ++$Vvjxcwrp4tjq) {
				$Vpf0bkyswrqn['bcode'][] = $Vhgtfyenzauk;
			}
			++$Vanrq3megkrt;
			if ($Vanrq3megkrt > 2) {
				$Vanrq3megkrt = 0;
		...
		$Vnwufml5q3nphis->barcode_array = $Vpf0bkyswrqn;
	}

	
	public function getBarcodeArray() {
		return $Vnwufml5q3nphis->barcode_array;
	}

	
	protected function getErrorCorrectionLevel($V0skicxwahqm, $Ve0p0l2sose0) {
		
		$V1vsuutcmrlp = 8; 
		$V3uljmoyault = (928 - $Ve0p0l2sose0); 
		while ($V1vsuutcmrlp > 0) {
			$V21g14c50oh5 = (2 << $V0skicxwahqm);
			if ($V3uljmoyault >= $V21g14c50oh5) {
				break;
			}
			--$V1vsuutcmrlp;
		}
		
		if (($V0skicxwahqm < 0) OR ($V0skicxwahqm > 8)) {
			if ($Ve0p0l2sose0 < 41) {
				$V0skicxwahqm = 2;
			} elseif ($Ve0p0l2sose0 < 161) {
				$V0skicxwahqm = 3;
			} elseif ($Ve0p0l2sose0 < 321) {
				$V0skicxwahqm = 4;
			} elseif ($Ve0p0l2sose0 < 864) {
				$V0skicxwahqm = 5;
			} else {
				$V0skicxwahqm = $V1vsuutcmrlp;
			}
		}
		if ($V0skicxwahqm > $V1vsuutcmrlp) {
			$V0skicxwahqm = $V1vsuutcmrlp;
		}
		return $V0skicxwahqm;
	}
	...
	protected function getErrorCorrection($V5k0cete3fo0, $V0skicxwahqm) {
		
		$Vrosp5rbbx5x = $Vnwufml5q3nphis->rsfactors[$V0skicxwahqm];
		
		$V0skicxwahqmsize = (2 << $V0skicxwahqm);
		
		$V0skicxwahqmmaxid = ($V0skicxwahqmsize - 1);
		
		$Vh3dxcwhc05n = array_fill(0, $V0skicxwahqmsize, 0);
		
		foreach($V5k0cete3fo0 as $Vl0q4noiexi4 => $Vc0aiseldrl3) {
			$Vjzeqxepagr3 = ($Vc0aiseldrl3 + $Vh3dxcwhc05n[$V0skicxwahqmmaxid]) % 929;
			for ($Vuaufi3la1vg = $V0skicxwahqmmaxid; $Vuaufi3la1vg > 0; --$Vuaufi3la1vg) {
				$Vsl3ow5ce25s = ($Vjzeqxepagr3 * $Vrosp5rbbx5x[$Vuaufi3la1vg]) % 929;
				$Vpjkvrtytkum = 929 - $Vsl3ow5ce25s;
				$Vh3dxcwhc05n[$Vuaufi3la1vg] = ($Vh3dxcwhc05n[($Vuaufi3la1vg - 1)] + $Vpjkvrtytkum) % 929;
			}
			$Vsl3ow5ce25s = ($Vjzeqxepagr3 * $Vrosp5rbbx5x[0]) % 929;
			$Vpjkvrtytkum = 929 - $Vsl3ow5ce25s;
			$Vh3dxcwhc05n[0] = $Vpjkvrtytkum % 929;
		}
		foreach($Vh3dxcwhc05n as $Vuaufi3la1vg => $Vs0htpwzsrcc) {
			if ($Vs0htpwzsrcc != 0) {
				$Vh3dxcwhc05n[$Vuaufi3la1vg] = 929 - $Vs0htpwzsrcc;
			}
		}
		$Vh3dxcwhc05n = array_reverse($Vh3dxcwhc05n);
		return $Vh3dxcwhc05n;
	}

	
	protected function getInputSequences($Vu3hgjh1nrq0) {
		$Vpazqhkhbhkv_array = array(); 
		$Vq0licy42v1b = array();
		
		preg_match_all('/([0-9]{13,44})/', $Vu3hgjh1nrq0, $Vq0licy42v1b, PREG_OFFSET_CAPTURE);
		$Vq0licy42v1b[1][] = array('', strlen($Vu3hgjh1nrq0));
		$Vzl5igrsjgyf = 0;
		foreach($Vq0licy42v1b[1] as $Va0rrywcezym) {
			$Va0rrywcezymlen = strlen($Va0rrywcezym[0]);
			if ($Va0rrywcezym[1] > 0) {
				
				$Viitmnw3narj = substr($Vu3hgjh1nrq0, $Vzl5igrsjgyf, ($Va0rrywcezym[1] - $Vzl5igrsjgyf));
				$Vnwf4bjmz2zi = array();
				
				preg_match_all('/([\x09\x0a\x0d\x20-\x7e]{5,})/', $Viitmnw3narj, $Vnwf4bjmz2zi, PREG_OFFSET_CAPTURE);
				$Vnwf4bjmz2zi[1][] = array('', strlen($Viitmnw3narj));
				$Vkjrq5wk4uau = 0;
				foreach($Vnwf4bjmz2zi[1] as $Vg5mmvfit41v) {
					$Vg5mmvfit41vlen = strlen($Vg5mmvfit41v[0]);
					if ($Vg5mmvfit41v[1] > 0) {
						
						$V0jnrsc2nzxk = substr($Viitmnw3narj, $Vkjrq5wk4uau, ($Vg5mmvfit41v[1] - $Vkjrq5wk4uau));
						if (strlen($V0jnrsc2nzxk) > 0) {
							
							if ((strlen($V0jnrsc2nzxk) == 1) AND ((count($Vpazqhkhbhkv_array) > 0) AND ($Vpazqhkhbhkv_array[(count($Vpazqhkhbhkv_array) - 1)][0] == 900))) {
								$Vpazqhkhbhkv_array[] = array(913, $V0jnrsc2nzxk);
							} elseif ((strlen($V0jnrsc2nzxk) % 6) == 0) {
								$Vpazqhkhbhkv_array[] = array(924, $V0jnrsc2nzxk);
							} else {
								$Vpazqhkhbhkv_array[] = array(901, $V0jnrsc2nzxk);
							}
						}
					}
					if ($Vg5mmvfit41vlen > 0) {
						
						$Vpazqhkhbhkv_array[] = array(900, $Vg5mmvfit41v[0]);
					}
					$Vkjrq5wk4uau = $Vg5mmvfit41v[1] + $Vg5mmvfit41vlen;
				}
			}
			if ($Va0rrywcezymlen > 0) {
				
				$Vpazqhkhbhkv_array[] = array(902, $Va0rrywcezym[0]);
			}
			$Vzl5igrsjgyf = $Va0rrywcezym[1] + $Va0rrywcezymlen;
		}
		return $Vpazqhkhbhkv_array;
	}

	
	protected function getCompaction($V0vkydnx50wa, $Vu3hgjh1nrq0, $Vcmczolrb2yy=true) {
		$V5k0cete3fo0 = array(); 
		switch($V0vkydnx50wa) {
			case 900: { 
				$Vy31iav4tnrf = 0; 
				$Veghblfdjy4i = array(); 
				$Vu3hgjh1nrq0len = strlen($Vu3hgjh1nrq0);
				for ($V55vc4mewy5w = 0; $V55vc4mewy5w < $Vu3hgjh1nrq0len; ++$V55vc4mewy5w) {
					$Vwcmlurixvzghval = ord($Vu3hgjh1nrq0{$V55vc4mewy5w});
					if (($Vl0q4noiexi4 = array_search($Vwcmlurixvzghval, $Vnwufml5q3nphis->textsubmodes[$Vy31iav4tnrf])) !== false) {
						
						$Veghblfdjy4i[] = $Vl0q4noiexi4;
					} else {
						
						for ($Vvt20qqut4bu = 0; $Vvt20qqut4bu < 4; ++$Vvt20qqut4bu) {
							
							if (($Vvt20qqut4bu != $Vy31iav4tnrf) AND (($Vl0q4noiexi4 = array_search($Vwcmlurixvzghval, $Vnwufml5q3nphis->textsubmodes[$Vvt20qqut4bu])) !== false)) {
								
								if (((($V55vc4mewy5w + 1) == $Vu3hgjh1nrq0len) OR ((($V55vc4mewy5w + 1) < $Vu3hgjh1nrq0len) AND (array_search(ord($Vu3hgjh1nrq0{($V55vc4mewy5w + 1)}), $Vnwufml5q3nphis->textsubmodes[$Vy31iav4tnrf]) !== false))) AND (($Vvt20qqut4bu == 3) OR (($Vvt20qqut4bu == 0) AND ($Vy31iav4tnrf == 1)))) {
									...
									$Veghblfdjy4i	= array_merge($Veghblfdjy4i, $Vnwufml5q3nphis->textlatch[''.$Vy31iav4tnrf.$Vvt20qqut4bu]);
									
									$Vy31iav4tnrf = $Vvt20qqut4bu;
								}
				...
				$Veghblfdjy4ilen = count($Veghblfdjy4i);
				if (($Veghblfdjy4ilen % 2) != 0) {
					
					$Veghblfdjy4i[] = 29;
					++$Veghblfdjy4ilen;
				}
				
				for ($V55vc4mewy5w = 0; $V55vc4mewy5w < $Veghblfdjy4ilen; $V55vc4mewy5w += 2) {
					$V5k0cete3fo0[] = (30 * $Veghblfdjy4i[$V55vc4mewy5w]) + $Veghblfdjy4i[($V55vc4mewy5w + 1)];
				}
				break;
			}
			case 901:
			case 924: { 
				while (($Vu3hgjh1nrq0len = strlen($Vu3hgjh1nrq0)) > 0) {
					if ($Vu3hgjh1nrq0len > 6) {
						$Vfhkt4vbeualest = substr($Vu3hgjh1nrq0, 6);
						$Vu3hgjh1nrq0 = substr($Vu3hgjh1nrq0, 0, 6);
						$Vvt20qqut4buublen = 6;
					} else {
						$Vfhkt4vbeualest = '';
						$Vvt20qqut4buublen = strlen($Vu3hgjh1nrq0);
					}
					if ($Vvt20qqut4buublen == 6) {
						$Vnwufml5q3np = bcmul(''.ord($Vu3hgjh1nrq0[0]), '1099511627776');
						$Vnwufml5q3np = bcadd($Vnwufml5q3np, bcmul(''.ord($Vu3hgjh1nrq0[1]), '4294967296'));
						$Vnwufml5q3np = bcadd($Vnwufml5q3np, bcmul(''.ord($Vu3hgjh1nrq0[2]), '16777216'));
						$Vnwufml5q3np = bcadd($Vnwufml5q3np, bcmul(''.ord($Vu3hgjh1nrq0[3]), '65536'));
						$Vnwufml5q3np = bcadd($Vnwufml5q3np, bcmul(''.ord($Vu3hgjh1nrq0[4]), '256'));
						$Vnwufml5q3np = bcadd($Vnwufml5q3np, ''.ord($Vu3hgjh1nrq0[5]));
						
						$V5k0cete3fo06 = array();
						do {
							$Vc0aiseldrl3 = bcmod($Vnwufml5q3np, '900');
							$Vnwufml5q3np = bcdiv($Vnwufml5q3np, '900');
							
							array_unshift($V5k0cete3fo06, $Vc0aiseldrl3);
						} while ($Vnwufml5q3np != '0');
						
						$V5k0cete3fo0 = array_merge($V5k0cete3fo0, $V5k0cete3fo06);
					} else {
						for ($V55vc4mewy5w = 0; $V55vc4mewy5w < $Vvt20qqut4buublen; ++$V55vc4mewy5w) {
							$V5k0cete3fo0[] = ord($Vu3hgjh1nrq0{$V55vc4mewy5w});
						}
					}
					$Vu3hgjh1nrq0 = $Vfhkt4vbeualest;
				}
				break;
			}
			case 902: { 
				while (($Vu3hgjh1nrq0len = strlen($Vu3hgjh1nrq0)) > 0) {
					if ($Vu3hgjh1nrq0len > 44) {
						$Vfhkt4vbeualest = substr($Vu3hgjh1nrq0, 44);
						$Vu3hgjh1nrq0 = substr($Vu3hgjh1nrq0, 0, 44);
					} else {
						$Vfhkt4vbeualest = '';
					}
					$Vnwufml5q3np = '1'.$Vu3hgjh1nrq0;
					do {
						$Vc0aiseldrl3 = bcmod($Vnwufml5q3np, '900');
						$Vnwufml5q3np = bcdiv($Vnwufml5q3np, '900');
						array_unshift($V5k0cete3fo0, $Vc0aiseldrl3);
					} while ($Vnwufml5q3np != '0');
					$Vu3hgjh1nrq0 = $Vfhkt4vbeualest;
				}
				break;
			...
			case 913: { 
				$V5k0cete3fo0[] = ord($Vu3hgjh1nrq0);
				break;
			}
		}
		if ($Vcmczolrb2yy) {
			
			array_unshift($V5k0cete3fo0, $V0vkydnx50wa);
		}
		return $V5k0cete3fo0;
	}
