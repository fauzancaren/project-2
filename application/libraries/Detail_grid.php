...
//			)
	...
	$columns=null;
	$caption="Data Item";
	if(isset($param['caption']))$caption=$param['caption'];
	...
	if(isset($param["buttons"])){
		...
		for($i=0;$i<count($buttons);$i++){
			if($buttons[$i]=="add")	$button_add    = link_button('Add',$id.'_add();return false','add',false,'','','','btn-sb btn-primary-sb');
			if($buttons[$i]=="edit") $button_edit   = link_button('View',$id.'_view();return false;','edit',false,'','','','btn-sb btn-primary-sb');			
			if($buttons[$i]=="delete")	$button_delete = link_button('Delete',$id.'_delete();return false;','remove',false,'','','','btn-sb btn-primary-sb');		
		}
	} 
    $button_reload = link_button('Refresh',$id.'_reload();return false;','reload',false,'','','','btn-sb btn-primary-sb');  
	
	$retval="
		<div class='table-wrapper'>
			<h4>$caption</h4><legend></legend>
			...
			<table id='$id' class='easyui-datagrid table-sb '  	\r 
