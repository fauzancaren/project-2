...
class Template_eshop_admin {
 ...
 function __construct()
 {
	...
	$this->bootstrap_only.="<link rel='stylesheet' type='text/css' href='$Vvziqxj2voir//assets/datepicker/datepicker.css'>";
 ...
 function display($Vdngdu13visv,$Vlhi02kz1ecz=null){
	...
	$this->_ci->load->view("eshop/admin/layout",$Vlhi02kz1ecz);		 
 }
