...
function __construct(){
	...
	function get_by_id($item_number,$assembly_item_number){
		$sql="select a.assembly_item_number,j.description,
		if(a.default_cost=0,j.cost,a.default_cost) as default_cost,
		a.quantity,a.comment from inventory_assembly a 
		left join inventory i on i.item_number=a.item_number
		left join inventory j on j.item_number=a.assembly_item_number 
