...
function show_fields($fields){
	for($i=0;$i<count($fields);$i++) {
		$fld=$fields[$i];			
		my_input(array("caption"=>$fld['caption'],"style"=>"style='width:70%;float:left'",
			"field_name"=>$fld['field'],"value"=>$fld['value'],"class"=>"col-md-6","extra"=>"class='col-md-6'",
			"show_button"=>link_button('Pilih','lookup_coa(\''.$fld['field'].'\')','search')
		));
	}
	...
	<div class="easyui-tabs">
		...
		<?php
			...
			array("caption"=>"Penyesuaian Stock (Stock Adjust)",
				...
				array("caption"=>"Stock Dalam Proses Produksi",
				"field"=>"txtCoaStockWip","value"=>$txtCoaStockWip)
