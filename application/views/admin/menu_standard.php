<div style="margin:10px 0;"></div>
	<ul class="easyui-tree">
		<li>
			...
			<li><?=anchor('#','User Login',' onclick=\'user_click()\';');?></li>
            ...
            <li>
<a href="#" onclick="test_new_tab();return false;">Test New Tab</a>
            </li>
					</ul>
				</li>
			</ul>
...
<script>
	function user_click(){
		show_page("User",CI_BASE+"index.php/user/add");
	}

	function test_new_tab(){
		show_page("User",CI_BASE+"index.php/admin/query/test");
		return false; 
	}
</script>