	...
	<div  class="easyui-tabs" style="width:auto;height:auto;min-height: 500px">
		<div title="Umum" id="box_section" class="thumbnail">
			<div class="thumbnail">				
				<table class="table">
					<tr>
						<td>Group Id</td><td><?=form_input("user_group_id",$user_group_id,"id='user_group_id' style='width:90%'")?>
						<br/><i>*Isi kode job singkat saja jangan ada tanda baca</i>
						</td>
					</tr>
					<tr>
						<td>Group Name</td><td><?=form_input("user_group_name",$user_group_name,"id='user_group_name' style='width:90%'")?></td>
					</tr>
					<tr>
						<td>Keterangan</td><td><?=form_input("description",$description,"id='description' style='width:90%'")?></td>
					</tr>				
				</table>
			</div>
		</div>
		<div title="Modules" id='box_section_job' class="thumbnail">
			<div class="thumbnail">
			<p> 
				<?php 
		...
		<div title='User' id='boxUser'>
			<table id="gdUser" class="easyui-datagrid"  
				data-options="
					iconCls: 'icon-edit', 
					singleSelect: true, fitColoumns:true,
					url: '<?=base_url()?>index.php/jobs/user_list/<?=$user_group_id?>',
					toolbar:'',
				">
				<thead>
					<tr>
						<th data-options="field:'user_id',width:80">User Id</th>
						<th data-options="field:'username',width:200">User Name</th>
						<th data-options="field:'cid',width:200">Cid</th>
					</tr>
				</thead>
			</table>  			
		</div>
