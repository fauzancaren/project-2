<div class="box-gradient" id="divToolbar">
	...
	if($mode=="view" || $mode=="edit") {
		if($show_tool) {
            ...
            if($show_save) echo link_button('Save', 'save_aed()','save','false',"" ,"","aed_button_save","btn-sb btn-primary-sb");   
			if($show_print) echo link_button('Print', 'print_aed();return false;','print',false,'','','','btn-sb btn-primary-sb');		
			if($show_refresh) echo link_button('Refresh','refresh_aed();return false;','reload',false,'','','','btn-sb btn-primary-sb');
			if($show_delete) echo link_button('Delete', 'delete_aed();return false;','remove',false,'','','','btn-sb btn-primary-sb');		
		}
	} else {
		if($show_tool) {
			if($show_save) echo link_button('Save', 'save_aed()','save','false',"" ,"","aed_button_save",'btn-sb btn-primary-sb')." ";	
	...
	if($show_tool) {
		if($posted) {
			if($show_posting) echo link_button('UnPosting','unposting_aed()','cut',false,'','','','btn-sb btn-primary-sb');
		} else {
			if($show_posting) echo link_button('Posting','posting_aed()','ok',false,'','','','btn-sb btn-primary-sb');
		}		
	}
	...
	<div style='float:right'>
    	<?=link_button('Help', 'load_help()','help',false,'','','','btn-sb btn-primary-sb')?>
    	 
    	<?=link_button('Close', 'remove_tab_parent()','cancel',false,'','','','btn-sb btn-primary-sb')?>
