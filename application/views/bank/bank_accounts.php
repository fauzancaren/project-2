	...
	<div title="General" style="padding:10px">
		...
		<table class="table2" width="100%">
			<tr>
			   ...
			   <tr>
			       <td>Nomor Bukti Masuk</td><td colspan=2><?php 
				   echo form_input('no_bukti_in',$no_bukti_in,"style='width:160px'");
				   echo link_button('',"autonum('no_bukti_in')",'search');
				   ?></td>
			   </tr>
			   <tr>                   
			       <td>Nomor Bukti Keluar</td><td colspan=2><?php 
				   echo form_input('no_bukti_out',$no_bukti_out,"style='width:160px'");
				   echo link_button('',"autonum('no_bukti_out')",'search')
				   ?></td>
                </tr>
