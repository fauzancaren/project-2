...
<form id="myform"  method="post" action="<?=base_url()?>index.php/coa/save">
	...
	<tr>
       ...
       <tr>
            <td>Nama Perkiraan</td><td><?php 
				echo form_input('account_description',$account_description,"style='width:400px'");
			?></td>
       </tr>
       <tr>
            <td>Posisi <?="db_or_cr=$db_or_cr"?></td><td>				
				<?php echo form_radio('db_or_cr','D',
					$db_or_cr=='0'||$db_or_cr=='',"style=width:30px");?>&nbsp Debet &nbsp 
                <?php echo form_radio('db_or_cr','C',
					!($db_or_cr=='0'||$db_or_cr==''),"style=width:30px");?>&nbsp Kredit &nbsp 
            </td>
       </tr>
       <tr>
            <td>Saldo Awal</td><td><?php echo form_input('beginning_balance',
			$beginning_balance);?></td>
       </tr>
       <tr>
            <td>Jenis Akun</td><td><?php echo form_dropdown( 'account_type',
			$account_type_list,$account_type,"style=width:300px");?></td>
       </tr>
       <tr>
            <td>Kelompok Akun</td><td><?php echo form_dropdown( 'group_type',
			$group_type_list,$group_type,"style=width:300px");?></td>
       </tr>
       <tr>
       </tr>
