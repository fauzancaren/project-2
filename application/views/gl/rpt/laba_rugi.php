<?php
     ...
     if($qprd=$CI->periode_model->get_by_id($period)){
         if($rprd=$qprd->row()){
             ...
             $enddate=$rprd->enddate;   //date("Y-m-d",strtotime($rprd->enddate));
     			    ...
     			    for($i=0;$i<count($qcoa);$i++){
                        ...
                        if($type=="D"){
                            ...
                            if($q1=$this->db->query($s)){
                                if($r1=$q1->row()){
                                    $amt_mtd=abs($r1->credit_base)-abs($r1->debit_base);
                                }
                            } 
                        }
                        ...
                        $amt_mtd_text=$amt_mtd;
                        $amt_ytd_text=$amt_ytd;
                        $amt_mtd_tot_text=$amt_mtd_tot;
                        $amt_ytd_tot_text=$amt_ytd_tot;
