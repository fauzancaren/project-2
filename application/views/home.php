...
if(isset($default_home)) {
    ...
    if($qapp=$this->db->where("is_active",1)->order_by("id")->get("maxon_apps")){
        ...
        if($iCntApp==0){
            echo "<p style='text-align:center'>Tidak ada aplikasi atau module yang diijinkan untuk anda jalankan. 
            <br/>Silahkan hubungi bagian IT untuk menseting jobdesk anda dan modul-modulnya.</p>";
        }
    } else {
    	echo 'error: maxon_apps table not found or empty';
    }
