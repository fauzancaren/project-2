...
<div class="container-fluid">
	...
	<div class='row-fluid'>
		<?php
			require_once "template/standard/header.php";
		?>
	</div>
			...
			<div >
				<div class="row">
					<div class="col-md-3">
						<div class="foot_logo">
							<a href="index.html">
							<img src="images/logo_maxon.png" alt="" height=100 width=150
								style="width:200px;height:150px;padding:10px"></a>
						</div>    
						<div class="copyright">� 2020 MaxOn Enterprise Resource Application. 
