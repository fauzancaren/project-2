...
<div title="Jurnal" id="jur-tab">
	<!-- JURNAL -->
	<?php 
		echo load_view("gl/jurnal_view",array("gl_id"=>$mat_rel_no));
	?>
...
<script type="text/javascript">
	...
	function posting(){
		...
		var url='<?=base_url()?>index.php/manuf/mat_release/posting/'+no;
				$.get(url,null,function(result){
					if (result.success){
						window.open(CI_BASE+"index.php/manuf/mat_release/view/"+no,"_self");
					} else {
						$.messager.show({	// show error message
							title: 'Error',
							msg: result.msg
	...
	function unpost(){
		...
		var url='<?=base_url()?>index.php/manuf/mat_release/unposting/'+no;
				$.get(url,null,function(result){
					if (result.success){
						window.open(CI_BASE+"index.php/manuf/mat_release/view/"+no,"_self");
					} else {
