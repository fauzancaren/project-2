	...
	<div id="divWoItem">
			...
			<thead>
				<tr>
					...
					<th data-options="field:'quantity',width:50,align:'right',
						editor:{type:'numberbox',options:{precision:2}}">Qty</th>
					<th data-options="field:'unit',width:50,align:'left',editor:'text'">Satuan</th>
					<th data-options="field:'price',width:50,align:'right',
						editor:{type:'numberbox',options:{precision:2}}">Cost</th>
					<th data-options="field:'total',width:50,align:'right',
						editor:{type:'numberbox',options:{precision:2}}">Total</th>
...
<script type="text/javascript">
	...
	function on_delete(){
		var nomor=$('#work_exec_no').val();
		if(nomor=="" || nomor=="AUTO"){
			log_msg("Nomor tidak ditemukan !");
			return false;
		}
 
		$.messager.confirm('Confirm','Are you sure you want to remove this?',function(r){
			if (r){
				url=CI_BASE+'/index.php/manuf/work_exec/delete/'+nomor+'/true';
				$.ajax({
