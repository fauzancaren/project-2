 <div class="thumbnail box-gradient">
	<?php  $themes=getvar("themes");
   $min_date=$this->session->userdata("min_date","");
	
	echo link_button('Save', 'save_db_memo()','save',false,'','','','btn-sb btn-success-sb');		
	echo link_button('Print', 'print_bukti()','print',false,'','','','btn-sb btn-primary-sb');		
	echo link_button('Add','','add','false',base_url().'index.php/purchase_dbmemo/add','','','btn-sb btn-success-sb');		
	echo link_button('Search','','search','false',base_url().'index.php/purchase_dbmemo','','','btn-sb btn-primary-sb');		
	echo link_button('Delete','delete_memo()','cut',false,'','','','btn-sb btn-danger-sb');		
	if($posted) {
		echo link_button('UnPosting','','cut','false',base_url().'index.php/purchase_dbmemo/unposting/'.$kodecrdb, 
		'','','btn-sb btn-primary-sb');		
	} else {
	...
	echo link_button('Refresh','','reload','false',base_url().'index.php/purchase_dbmemo/view/'.$kodecrdb, 
		'','','btn-sb btn-success-sb');		
	echo link_button('Help', 'load_help(\'purchase_dbmemo\')','help',false,'','','','btn-sb btn-info-sb');		
	
	?> 
    <?=link_button('Close','remove_tab_parent()','cancel',false,'','','','btn-sb btn-danger-sb')?>      
</div>
<div class="thumbnail">		
   ...
   <table class="table2" width="100%">
       ...
       <tr>
            ...
            <td><?=form_input('supplier_number',$supplier_number,'id="supplier_number"');?>
            	<?=link_button("Pilih",'dlgsuppliers_show()','search','false',
					'','','','btn-sb btn-primary-sb',
					$themes=="admin"?"data-target='#dlgsuppliers' data-toggle='modal'":"")?>
            </td>
			<td rowspan="2">
       ...
       <tr>
            ...
            <td><?=form_input('docnumber',$docnumber,'id="docnumber"');?>
				<?=link_button("Pilih",'dlgpurchase_invoice_show();return false;','search','false',
					'','','','btn-sb btn-primary-sb',
					$themes=="admin"?"data-target='#dlgpurchase_invoice' data-toggle='modal'":"")?>
            </td>			 
       </tr>
       <tr>
       		<td>Jumlah: </td>
       ...
       <tr>
		...
		<tr>
			...
			<td colspan=2>
	            ...
	            echo link_button('Pilih','dlgdoc_type_show();return false;',"search","false",
				'','','','btn-sb btn-primary-sb',
				$themes=="admin"?"data-target='#dlgdoc_type' data-toggle='modal'":""); 
	            echo link_button('Tambah',"dlgdoc_type_list('doc_type_podb');return false;","add","false",
				'','','','btn-sb btn-success-sb'); 
		...
		<tr>
			...
			<td colspan=2>
            	...
            	<?=link_button("Pilih",'dlgoutlet_show();return false;','search','false',
					'','','','btn-sb btn-primary-sb',
					$themes=="admin"?"data-target='#dlgoutlet' data-toggle='modal'":"")?>
			</td>
			...
			<tr>
			    <form id="frmItem" method='post' >
			         <td><input id="account" style='width:80px' 
						...
						<a href="#" class="easyui-linkbutton btn-sb btn-primary-sb" 
						iconCls="icon-search" plain="false"
						<?php if($themes=="admin")echo "data-target='#dlgchart_of_accounts' data-toggle='modal' ";?>
						onclick="lookup_coa();return false;">Pilih</a>
			         </td>
			         <td><input id="description" name="description" style='width:280px'></td>
			        <td><input id="amount" name="amount"  style='width:80px'  
						class="easyui-validatebox" 
						validType="numeric"></td>
			        <td><a href="#" class="easyui-linkbutton btn-sb btn-primary-sb" data-options="iconCls:'icon-save'"  
...
<div id="tb" style="height:auto" class="table box-gradient">
	<a href="#" class="easyui-linkbutton btn-sb btn-primary-sb" iconCls="icon-edit" plain="false" 
		onclick="editItem()">Edit</a>
	<a href="#" class="easyui-linkbutton btn-sb btn-danger-sb" iconCls="icon-remove" plain="false" 
		onclick="deleteItem()">Delete</a>	
</div>
