	...
	<table class="table" width="100%">
		<tr>
			<td>Nomor Kontra Bon</td><td width=300>
				<?php echo form_input('nomor',$nomor,"id=nomor style='width:150px' "); ?>
			</td>
       ...
       <tr>
            <td>Tanggal</td><td><?php echo form_input('tanggal',$tanggal,'style="width:150px" id=tanggal   
       ...
       <tr>
			...
			'style="width:150px"  id=tgl_jth_tempo  class="easyui-datetimebox" 
			data-options="formatter:format_date,parser:parse_date"
			required');?></td>
       </tr>
...
//        	log_err("Isi amount memo !");return false;
			...
			$('#frmPo').form('submit',{
				...
				success: function(result){
					...
					if (result.success){
						...
						if(result.data!=null){
							$("#tgl_jth_tempo").datetimebox('setValue',result.data['tgl_jth_tempo']);
						}
	...
	function supplier_info(){
        ...
        $.ajax({
                type: "GET",
                url: "<?=base_url()?>/index.php/po/kontra_bon/supplier_info/"+supp,
                data: "",
                success: function(result){
