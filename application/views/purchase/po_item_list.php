...
">
	<thead>
		<tr>
			...
			<th data-options="<?=col_number('quantity')?>">Qty</th>
		...
		<th data-options="<?=col_number('qty_recvd')?>">Qty Recvd</th>
			...
			<th data-options="field:'received',width:80,align:'right'">Recv?</th>
