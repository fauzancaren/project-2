<?php 
$gdg_count=0;
if(!isset($gdg))$gdg=$this->db->get("shipping_locations");
					...
					<div title="Detail" style="padding:10px">
						<table class='table2' style='width:100%;'>
						 ...
						 <tr><td>Quantity</td><td><input id="quantity"  style='width:60px'  
							...
							Price <input id="price" name="price"   onblur="hitung();return false;" >
						</tr>
						<tr>
							<td colspan=3>
							<span id='divMultiUnit' style='display:none'>
								M_Qty <?=form_input("mu_qty","","id='mu_qty' style='width:60px'   onblur='hitung();return false;' ")?>
								M_Unit <?=form_input("multi_unit","","id='multi_unit' style='width:60px' ")?>
								M_Price <?=form_input("mu_harga","","id='mu_harga'","  onblur='hitung();return false;' ")?>
							</span>
							</td>
						</tr>
						</td>
