...
<div class="thumbnail tool box-gradient">
	<?php
		...
		array("mode"=>$mode,"help"=>"purchase_request"));
	?>
</div>
           ...
           <table class='table2' width="100%">
               ...
               <tr>
					...
					<td><?php 
						...
						echo link_button('Cari','dlgemployee_show()',"search","false",'','',
							'cmdLovPegawai','btn-sb btn-primary-sb');						
						?>                    
                    </td>
...
//						if($mode=="add" || !$allow_ch_status_poreq){
							...
							if($doc_status=="OPEN" || $doc_status==""){
								echo link_button('Approve','approve();return false','save',false,'','','','btn-sb btn-primary-sb');
							}
//						} else {
...
//						}
        			...
        			//if($mode=="add") 
        				echo link_button('Cari','dlggl_projects_show();return false;',"search","false",'','','','btn-sb btn-primary-sb'); 
                    ?>
        			</td>
               </tr>
               <tr>
	...
	<div title="Items" style="padding:3px">
	...
	<div title='Receive' style="padding:3px">
		<?php 
			echo $this->detail_grid->render(
	...
	<div title='Purchase Order' style="padding:3px">
			<?php 
			echo $this->detail_grid->render(
