<div class="thumbnail box-gradient">
	...
	echo link_button('e_faktur', 'e_faktur()','print');		
...
<div class="easyui-tabs" >
    ...
    <div id='divItem' title='Items' style="min-height:350px">
		...
		<table id="dg" class="easyui-datagrid"  width='2000px'  			 
			data-options="iconCls: 'icon-edit', fitColumns: true, 
				singleSelect: true,	toolbar: '#tb',	url: ''	">
			<thead>
				<tr>
					...
					<th data-options="field:'price',align:'right',editor:'numberbox',
						formatter: function(value,row,index){
							return number_format(value,2,'.',',');}">Harga</th>

					<th data-options="field:'discount',editor:'numberbox'">Disc1%</th>
					<th data-options="field:'discount_amount',align:'right',editor:'numberbox',
						formatter: function(value,row,index){
							return number_format(value,2,'.',',');}">Disc1 Rp</th>
					<th data-options="field:'disc_2',editor:'numberbox'">Disc2%</th>
					<th data-options="field:'disc_amount_2',align:'right',editor:'numberbox',
						formatter: function(value,row,index){
							return number_format(value,2,'.',',');}">Disc2 Rp</th>
					<th data-options="field:'disc_3',editor:'numberbox'">Disc3%</th>
					<th data-options="field:'disc_amount_3',align:'right',editor:'numberbox',
						formatter: function(value,row,index){
							return number_format(value,2,'.',',');}">Disc3 Rp</th>
					...
					<th data-options="field:'cost',align:'right',editor:'numberbox',
						formatter: function(value,row,index){
					...
					<th data-options="field:'no_urut',align:'right'">NoUrut</th>
...
?>
 ...
 <script language='javascript'>
    ...
    function e_faktur(){
			txtNo=$("#invoice_number").val(); 
            window.open("<?=base_url().'index.php/invoice/e_faktur/'?>"+txtNo,"new");
		}
  	function payment(){
            txtNo=$("#invoice_number").val(); 
