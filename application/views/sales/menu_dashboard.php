	       ...
	       <div class='col-md-4'>
            ...
            <div class='col-md-8'>
                <table id="dgRetur" class="easyui-datagrid"  
                    style="heighx:400px"
                    data-options="title: 'Penjualan per Tanggal',
                        iconCls: 'icon-tip',fitColumns: true,
                        singleSelect: true,
                        toolbar: '',
                        url: '<?=base_url()?>index.php/invoice/sales_by_date'
                    ">
                    <thead>
                        <tr>
                            <th data-options="field:'tanggal',width:60">Tanggal</th>
