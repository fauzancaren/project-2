<div class='col-md-12'>
    ...
    <li><?=anchor('sales/rpt/so_do_faktur','So->Do->Faktur->Item ',"class='info_link'")?></li>
    </div>
    <div class='col-md-5'>
...
<li><?=anchor('sales/rpt/sls_item','Penjualan per Item (Summary)',"class='info_link'")?></li>
<li><?=anchor('sales/rpt/sls_item_detail','Penjualan per Item (Detail)',"class='info_link'")?></li>
...
<li><?=anchor('sales/rpt/sls_item_spg','Penjualan per Item SPG',"class='info_link'")?></li>
...
<div class='col-md-5'>
<h4>FAKTUR PAYMENT</h4>
<li><?=anchor('sales/rpt/faktur_saldo','Daftar Saldo Faktur',"class='info_link'")?></li>
