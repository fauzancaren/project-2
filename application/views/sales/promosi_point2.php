...
<?php
	...
	$browse=new browser();
	$limit=10;
	$s="select p.item_number,
	if(coalesce(i.description,''),c.category,i.description) as description,
	p.item_type,p.id from promosi_item p 
