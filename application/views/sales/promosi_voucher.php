...
closed="true" buttons ="#dlgItemTool">
    <form id="frmVoucher"  method="post">
        ...
        <table class='table2' width='100%'>
            ...
            <tr><td>Aktif</td><td><?=form_input_date("tanggal_aktif",date("Y-m-d"),"id='tanggal_aktif' style='width:300px'")?></td>
            <tr><td>Expire</td><td><?=form_input_date("tanggal_expire",date("Y-m-d"),"id='tanggal_expire' style='width:300px'")?></td>
        </table>
    </form>
</div>    
<div id='dlgItemTool'>
