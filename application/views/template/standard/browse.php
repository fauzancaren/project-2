...
<div class="container" >	 
	...
	<div class="row-fluid">
		...
		-		class="easyui-datagrid table" style="width:auto;height:250px"
...
<div id="dlg<?=$table_name?>" class="easyui-dialog" style="width:600px;height:350px;left:100px;top:20px;padding:5px 5px"
