...
<div class='box-gradient' id='tb_<?=$controller_name?>' >
	<?=link_button("Tambah", "addnew_$controller_name();return false;","add","false");?>
	<?=link_button("Ubah", "edit_$controller_name();return false;","edit","false");?>
	<?=link_button("Hapus", "del_row_$controller_name();return false;","remove","false");?>
	<?php
	...
	echo " Find: <input type='text' id='tb_search' value='$search' 
		onchange='find_$controller_name();return false;'>";
	echo link_button('','find_'.$controller_name."();return false;",'search');
	echo link_button("Set", "set_".$controller_name."();return false;",'lock');
	
	echo link_button('Reload','refresh_tab_parent()','reload');
...
<script type="text/javascript">
    ...
    function barcode_<?=$controller_name?>(){
        ...
        if (filter != '')xurl_add=xurl_add+'?filter='+filter;
		add_tab_parent("Print_barcode_<?=$controller_name?>",xurl_add);
    };
    ...
    function cari_<?=$controller_name?>(){
	    ...
	    <?php
			...
			if($search!="")echo "xurl2=xurl2+'&tb_search=$search';";
        ?>
