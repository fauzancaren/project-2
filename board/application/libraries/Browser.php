...
class Browser
{
	...
	function toolbar($page=0,$item_page_max=10,$limit=50,$show_add_button=true) 
	{
		...
		<div class=\"btn-groupx\" role=\"group\" aria-label=\"Navigation Button\" style='float:left'>
			...
			</br>".form_input("txtSearch",'',"id='txtSearch' placeholder='Enter search	' class='' style='height:32px;margin-top:6px'")."
		...
		<div class='btn-groupx col-md-6' role='group' aria-label='Record' style='float:left'>
