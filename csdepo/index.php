	    ...
	    <li class="nav-item menu-items">
            ...
            <div class="collapse" id="auth">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="pages/tables/basic-sj.php"> Items</a></li>
                <li class="nav-item"> <a class="nav-link" href="pages/tables/basic-data-sj.php"> Data </a></li>
		  ...
		  <li class="nav-item menu-items">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="pages/tables/basic-undian.php">Add</a></li>
                <li class="nav-item"> <a class="nav-link" href="pages/tables/basic-data-undian.php">Data</a></li>
				 <li class="nav-item"> <a class="nav-link" href="pages/tables/basic-data-undian-edit.php"> Edit </a></li>
                </ul>
            </div>
          </li>
		   ...
		   <li class="nav-item menu-items">
            ...
            <div class="collapse" id="ui-point">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="pages/tables/basic-point.php">Add</a></li>
                 <li class="nav-item"> <a class="nav-link" href="pages/tables/basic-data-point.php">Data</a></li>
				 <li class="nav-item"> <a class="nav-link" href="pages/tables/basic-data-point-edit.php"> Edit </a></li>
                </ul>
            </div>
          </li>
