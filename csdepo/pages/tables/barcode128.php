...
<style>
		...
		p.inline {display: inline-block; margin-right:25px}
		span { font-size: 10px;}
		</style>
<?php
...
</style><table cellpadding=0 cellspacing='0' style='margin:0 auto'><tr>"; 
  for($x=0;$x<strlen($w);$x+=2) // code 128 widths: black border, then white space
		 $html .= "<td><div class=\"b128\" style=\"border-left-width:{$w[$x]};width:{$w[$x+1]}\"></div></td>";  
 return "$html<tr><td colspan=".strlen($w)."
		 align=\"center\"><font family=arial size=2><b>$text</td></tr><tr><td colspan=".strlen($w)." 
		 align=\"left\"><b><font family=arial size=4></td></tr></table>"; 
}
?>
