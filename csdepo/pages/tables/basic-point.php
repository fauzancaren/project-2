            ...
            <div class="page-header">
              ...
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">Add Point</li>
                </ol>
              </nav>
...
<div class="row">
	<div class="container">
		...
		<tbody>
			...
			?>
			<form  action='add-point.php' method="POST">
			<tr>
			<td>No FJK</td>
			<td>&nbsp;:</td>
			...
			<td>ID Member</td>
			<td>&nbsp;:</td>
			<td><input type="text" style="background:black;" name='sold_to_customer' value="<?php echo $row['sold_to_customer']; ?>"  
			class="form-control" readonly></td>
			</tr>
			<tr>
			<td>Amount</td>
			<td>&nbsp;:</td>
			<td><input type="text" style="background:black;" name='amount' value="<?php echo number_format($row['amount']); ?>"  
			class="form-control" readonly></td>
			</tr>
			<?php
			$bagi = 100000;
			...
			<td>Point</td>
			<td>&nbsp;:</td>
			<td><input type="text" style="background:black;" name='jumlah_point' value="<?php echo floor($point) ?>"  
			class="form-control" readonly></td>
			</tr>
			
			<tr>
			   <td colspan="2"><input type="submit" class='btn btn-success' name="simpan" value="Simpan"></td>
			 </tr>
			 </form>
