...
//    $this->library_src.=$this->_cjs('assets/flexslider/jquery.flexslider.js',true);
    ...
    $this->library_src.=$this->_cjs('js/lib.js?v=11',true);
    $this->library_src.=$this->_cjs('assets/pos/lib_pos.js?v=29',true);
    $this->library_src.=$this->_cjs('js/lib_input.js?v=9',true);
...
// 	$data['script_head']=$script_head;
 ...
 function display_table($data=null) {
    $data['message']='Ready';
	$template="";
	if(isset($data['template']))$template=$data['template'];
