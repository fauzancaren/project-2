...
<head><title>Jobii software </title>
<!-- </head> --></head>
...
<div class="container " >
	...
	<div class="row">
		...
		<div class="copyright" style='font-size:12px'>Copyright 2016 - 2023<br>Jobii Enterprise Resource Application. 
		<br>All Rights Reserved.<br>https://jobii.id</div>                        
		</div>
		</div>
	</div>	
	<?php } ?>
