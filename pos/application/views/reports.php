...
<div class='row'>
    ...
    <div class='col-md-6'>
        ...
        <li><?=anchor(base_url("index.php/reports/criteria/rangkum"),
            "01. Rangkuman Penjualan Harian","target='_blank'")?></li>
        <li><?=anchor(base_url("index.php/reports/criteria/faktur_sum"),
            "02. Penjualan Summary","target='_blank'")?></li>
        <li><?=anchor(base_url("index.php/reports/criteria/faktur_slsman"),
            "02. Penjualan per Kasir","target='_blank'")?></li>
        <li><?=anchor(base_url("index.php/reports/criteria/pay_list"),
            "03. Penjualan per Jenis Pembayaran","target='_blank'")?></li>
        <li><?=anchor(base_url("index.php/reports/criteria/sls_item"),
            "04. Penjualan per Kode Barang","target='_blank'")?></li>
        <li><?=anchor(base_url("index.php/reports/criteria/sls_cat"),
            "05. Penjualan per Kelompok Barang","target='_blank'")?></li>
            
        <li><?=anchor(base_url("index.php/reports/criteria/faktur_cust"),
            "06. Penjualan per Kode Pelanggan","target='_blank'")?></li>
        <li><?=anchor(base_url("index.php/reports/criteria/print_faktur"),
            "07. Penjualan Nota Detail","target='_blank'")?></li>
        <li><?=anchor(base_url("index.php/reports/criteria/print_faktur_tabel"),
            "07. Penjualan Nota Detail (Tabel)","target='_blank'")?></li>
            
        <li><?=anchor(base_url("index.php/reports/criteria/sls_sistim"),
...
<li><?=anchor('reports/criteria/sls_wil_cust','Penjualan Wilayah, Customer ',"class='info_link'")?></li>
        ...
        <li><?=anchor(base_url("index.php/reports/criteria/slsman_list"),
