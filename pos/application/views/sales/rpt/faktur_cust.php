<?php
	...
	$CI->load->model('kartu_invoice_model');
	$CI->kartu_invoice_model->_date_from=$date1;
	$CI->kartu_invoice_model->_date_to=$date2;
	$CI->kartu_invoice_model->_sold_to_customer=$cust;
	$CI->kartu_invoice_model->_order_by="sold_to_customer,invoice_date";
	$rows=$CI->kartu_invoice_model->load_data();
?>
