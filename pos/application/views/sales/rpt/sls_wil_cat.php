...
<table cellspacing="0" cellpadding="1" border="0" width='800px'> 
     ...
     <tr>
     	<td colspan="8">
     			...
     			sum(il.amount) as z_omset,sum(il.quanity) as z_qty
				...
				$sub_total=0;
                 foreach($rst_so->result() as $row){
                    ...
                    $tbl.="<td align='right'>".number_format($qtyt)."</td>";
                ...
                $tbl.="</tr>";
         		...
         		$tbl.="<tr><td colspan=3><b>SUB TOTAL [$region_old]</b></td><td></td><td align=right><b>".number_format($sub_total,2)."</b></td></tr>";
